...
static constexpr auto s_tag = "[CaloJetTimingProducer]";

TEST_CASE("Standard checks of CaloJetTimingProducer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("CaloJetTimingProducer"
